...
const nav = [
  ...
  {
    text: 'Changelog',
    link: 'https://github.com/stacksjs/ts-validation/blob/main/CHANGELOG.md',
  },
...
const title = 'ts-validation | A TypeScript Starter Kit. For a better Development Experience.'
...
export default withPwa(
  defineConfig({
    ...
    head: [
      ...
      ['meta', {
        name: 'tags',
        content: 'ts-validation, stacksjs, reverse proxy, modern, lightweight, zero-config, local development',
      }],
      ...
      ['meta', { property: 'og:site_name', content: 'ts-validation' }],
